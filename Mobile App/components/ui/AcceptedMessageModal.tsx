...
interface AcceptedMessageModalProps {
  visible: boolean;
  onClose: () => void;
}

const AcceptedMessageModal: React.FC<AcceptedMessageModalProps> = ({
  visible,
   onClose,
}) => {
  return (
        ...
        <View style={styles.messageContainer}>
          <View style={styles.contentContainer}>
            ...
            <TouchableOpacity
              onPress={onClose}
            >
              <Text style={styles.messageText}>Accepted</Text>
            </TouchableOpacity>
          </View>
...
export default AcceptedMessageModal;