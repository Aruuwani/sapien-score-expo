...
interface NotScoredModalProps {
  visible: boolean;
  onClose: () => void;
}

const NotScoredModal: React.FC<NotScoredModalProps> = ({
  visible,
   onClose,
}) => {
  return (
        ...
        <View style={styles.messageContainer}>
          <View style={styles.contentContainer}>
            ...
            <TouchableOpacity
              onPress={onClose}
            >
              <Text style={styles.messageText}>You must score in at least one category to proceed.</Text>
            </TouchableOpacity>
          </View>
